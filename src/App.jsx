...
const COPY = {
  zh: {
    ...
    heroTitle: '今晚食咩？',
    heroDescription:
      '300 道香港家庭菜式，材料容易買到。中、英、印尼文對照，跟住每一步就煮得到。',
  ...
  en: {
    ...
    heroDescription:
      '300 Hong Kong family recipes with easy-to-find ingredients. Follow every step in Chinese, English or Bahasa Indonesia.',
    ...
    loadingRecipes: 'Loading 300 recipes…',
  ...
  id: {
    ...
    heroDescription:
      '300 resep keluarga Hong Kong dengan bahan yang mudah dibeli. Ikuti setiap langkah dalam Bahasa Indonesia, Inggris, atau Mandarin.',
    ...
    loadingRecipes: 'Memuat 300 resep…',
